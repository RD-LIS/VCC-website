...
const SEC01_CONFIG = {
  ...
  // PC 설정 (1024px 이상)
  desktop: {
    videoSrc: 'https://richdivine-vcc.com/static2026/sec01_vid1rr.mp4',
  ...
  // 모바일 설정 (1024px 미만)
  mobile: {
    videoSrc: 'https://richdivine-vcc.com/static2026/sec01_vid2rr.mp4', // 별도 모바일용 세로 영상이 있다면 변경 가능 (없으면 원본 지정)
